...
const memory_db_1 = require('../src/memory_db');
const text_db_1 = require('../src/text_db');
let db;
describe('basic operations', function () {
    beforeEach(function () {
        db = new memory_db_1.default();
    });
...
describe('basic operations on demo data', function () {
    beforeEach(function () {
        db = new text_db_1.default({ path: __dirname + '/../../example', activeLog: true });
    });
...
//# sourceMappingURL=basic_operations.js.map