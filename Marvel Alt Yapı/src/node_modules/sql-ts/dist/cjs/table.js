...
class Table {
    ...
    createColumn(col) {
        if (!(col instanceof column_1.Column)) {
            ...
            const column = new column_1.Column(Object.assign(Object.assign({}, col), { table: this }));
            // Load subfields from array into an object of form name: Column
            if (Array.isArray(col.subfields)) {
                column.subfields = fromPairs_1.default(map_1.default(col.subfields, (subfield) => {
                    return [
                        subfield,
                        new column_1.Column({
                            name: subfield,
