...
class PostfixUnaryNode extends _1.Node {
    constructor(config) {
        ...
        if (!valueExpressionMixed) {
            ...
            extend_1.default(PostfixUnaryNode.prototype, _1.valueExpressionMixin());
        }
    }
}
exports.PostfixUnaryNode = PostfixUnaryNode;
extend_1.default(PostfixUnaryNode.prototype, _1.AliasNode.AliasMixin);
//# sourceMappingURL=postfixUnary.js.map